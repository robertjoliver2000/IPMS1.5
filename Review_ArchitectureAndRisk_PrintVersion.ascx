<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Review_ArchitectureAndRisk_PrintVersion.ascx.cs" Inherits="Controls_Review_ArchitectureAndRisk_PrintVersion" %>
...
<table cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        </uc6:Review_SectionF_PrintVersion>
        </td>
    </tr>       
    <tr>
        <td>
