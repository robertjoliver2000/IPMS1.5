...
<%@ Reference VirtualPath="~/Controls/Summary.ascx"%>
<%@ Reference VirtualPath="~/Controls/Review_Summary.ascx"%>

<%@ Reference VirtualPath="~/Controls/Financial.ascx"%>
<%@ Reference VirtualPath="~/Controls/Review_Financial.ascx"%>

<%@ Reference VirtualPath="~/Controls/ArchitectureAndRisk.ascx"%>
<%@ Reference VirtualPath="~/Controls/Review_ArchitectureAndRisk.ascx"%>

<%@ Reference VirtualPath="~/Controls/Projects.ascx"%>
<%@ Reference VirtualPath="~/Controls/Review_Projects.ascx"%>

<%@ Reference VirtualPath="~/Controls/WorkflowAction.ascx"%>
<%@ Reference VirtualPath="~/Controls/Review_WorkflowAction.ascx"%>

<%@ Reference VirtualPath="~/Controls/PIR_WorkflowAction.ascx"%>

<%@ Reference VirtualPath="~/Controls/PIR_Summary.ascx"%>


<%@ Reference VirtualPath="~/Controls/IGAudit.ascx"%>

<%@ Reference VirtualPath="~/Controls/section_status.ascx"%>
...
<head runat="server">
    <title runat="server" text="<%$ AppSettings:ApplicationName %>"></title>
    <link href="style.css" type="text/css" rel="stylesheet" />
    <link href="ImageDdl.css" type="text/css" rel="stylesheet" />
</head>
<body leftmargin="0" topmargin="0" bottommargin="0" marginwidth="0" marginheight="0" onload="javascript:setH();enableWorkflowButton();">
