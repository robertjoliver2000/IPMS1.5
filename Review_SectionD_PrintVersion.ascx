<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Review_SectionD_PrintVersion.ascx.cs" Inherits="ProjectPortfolio.Controls.Review_SectionD_PrintVersion" %>
<table class="def" width="100%" cellpadding="1" cellspacing="1" border="0">
	...
	<tr valign="middle">
		...
		<td width="48px">&nbsp;</td>
		<td class="summarylabel" width="130px">CURRENT IG IDENTIFIER:</td>
