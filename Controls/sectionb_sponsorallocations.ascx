<%@ Control Language="c#" Inherits="ProjectPortfolio.Controls.SectionB_SponsorAllocations" CodeFile="sectionB_SponsorAllocations.ascx.cs" %>
...
<table cellpadding="2" cellspacing="2" style="border: 1px solid #CCCCCC; ">
	...
	<tr>
	    <td valign="top">
	        <table cellpadding="2" cellspacing = "0">
	            <tr>
		            <td class="sponsorallocationlabel" style="FONT-WEIGHT:bold">BA</td>
		            <td style="FONT-WEIGHT:bold">% Alloc.</td>
	            </tr>
	            <tr>
		            <td colspan="2">
		            </td>
    ...
    <tr>
        <td colspan="5">
            ...
            <asp:CustomValidator ID="sectionB_cvSponsorAllocations" runat="server" Display="Dynamic" Text="Sponsor allocations percentages must add up to 100%!" ErrorMessage="Sponsor allocations percentages must add up to 100%!" ClientValidationFunction="validatePercentsOnSubmitForReview" ValidationGroup="SubmitForReview"></asp:CustomValidator>
        </td>
    </tr>
<%--
	<tr>
		<td class="sponsorallocationlabel" style="FONT-WEIGHT:bold; TEXT-ALIGN:left" colspan="3">Allocations agreed with Sponsors?
		</td>
		<td colspan="2" align="left">
            ...
            <asp:RequiredFieldValidator ID="sectionB_rvAllocationAgreedDDL" runat="server" ControlToValidate="ddlAllocationAgreed"
                ErrorMessage="Allocation Agreed must not be blank" InitialValue="0" ValidationGroup="SubmitForReview"
	...
	<tr>
		<td class="sponsorallocationlabel" style="FONT-WEIGHT:bold; TEXT-ALIGN:left" colspan="3">Initiative budgeted for current year?
		</td>
		<td colspan="2" align="left">
            ...
            <asp:RequiredFieldValidator ID="sectionB_rvInitiativeBudget" runat="server" ControlToValidate="ddlInitiativeBudget"
...
--%>
    <tr>
        <td colspan="5">
            <table>
				<tr>
					<td class="sponsorallocationlabel" style="FONT-WEIGHT:bold; TEXT-ALIGN:left">
			    ...
			    <tr>
                    <td class="sponsorallocationlabel" style="font-weight: bold; text-align: left"
                        width="250">
                        Basis for allocation?<br />
                        </td>
                    <td align="left">
                        <asp:DropDownList ID="ddlBasisForAllocation" runat="server" CssClass="textselect"
                            Width="105px">
