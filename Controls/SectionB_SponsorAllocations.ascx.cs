namespace ProjectPortfolio.Controls
{
    ...
    public partial class SectionB_SponsorAllocations : System.Web.UI.UserControl
	{
     ...
     //       m_dsSponsors = SectionB_SponsorAllocations_DB.GetSponsorMapping();
 		...
 		private void LoadInitiative()
		{
			...
			DataRow drInitiative = SectionB_SponsorAllocations_DB.GetInitiativeDetails( m_nInitiativeID, true );
