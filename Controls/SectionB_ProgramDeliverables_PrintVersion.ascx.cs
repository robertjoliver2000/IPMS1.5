...
public partial class Controls_SectionB_ProgramDeliverables_PrintVersion : System.Web.UI.UserControl
{
    ...
    protected void rptProgramDeliverables_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            else
            {
                ...
                //imgDelete.Attributes.Add("onClick", "javascript:return confirm('Are you sure you wish to delete this deliverable?')");
            }
        }
    }
