<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProgrammeManager.ascx.cs" Inherits="Controls_Coordinator" %>
<script language="javascript" type="text/javascript">
 
function popupWindowNewReview(initiativeID)
{
    
    var returnCode;
	returnCode= window.showModalDialog("NewReview.aspx?InitiativeID=" + initiativeID, 
    ...
    <tr>
        ...
        <td valign="top" style="border: solid 1px #CCCCCC"> 
            <table cellpadding="2" cellspacing="0" >
                ...
                <tr>
	                <td class="mp_summarylabel" width="180px" style="height: 42px">IG Approval Committee</td>
                </tr>
                <tr>
	                <td style="height: 26px"><asp:DropDownList Runat="server" ID="ddlIGApprovalCommittee" CssClass="textselect" Width="140px"></asp:DropDownList></td>
                </tr>
                <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="20px" align="center">
                                    <a runat="server" id="lnkApprovalDateFrom">
                                        <img src="Images/calendar.jpg" border="0" id="Img3"></a></td>
                            ...
                            <tr>
                                <td valign="top" style="height: 19px">
                                    <font face="verdana, arial, helvetica, sans-serif" color="#333333" size="1"><em>dd/mm/yyyy</em></font></td>
                            ...
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtApprovalDateTo" runat="server" CssClass="textinput" MaxLength="200"
                                        Style="text-align: center" Width="100px"></asp:TextBox></td>
                                <td width="20px" align="center">
                                    <a runat="server" id="lnkApprovalDateTo">
                                        <img src="Images/calendar.jpg" border="0" id="Img2"></a></td>
                                <td align="center" style="width: 20px">
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="20px" align="center"><a runat="server" id="lnkReviewDate"><img src="Images/calendar.jpg" border="0" id="IMG1"></a></td>
                                <td align="center" style="width: 20px"><asp:RangeValidator ID="rvReviewDate" runat="server" ControlToValidate="txtReviewDate" Text="*" MaximumValue="1/1/2020" MinimumValue="1/1/1900" Type="Date" ></asp:RangeValidator></td>
                            </tr>
	                        <tr>
	                            <td valign="top" style="height: 19px"><font face="verdana, arial, helvetica, sans-serif" color="#333333" size="1"><em>dd/mm/yyyy</em></font></td>
             ...
             <asp:GridView AutoGenerateColumns="False" EnableViewState="False" runat="Server" ID="gvInitiatives" 
                ...
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="InitiativeID" DataNavigateUrlFormatString="~/default.aspx?section=1&amp;InitiativeID={0}" DataTextField="Name" HeaderText="Initiative Name" SortExpression="Name">
                        <HeaderStyle CssClass="mp_headcell" Width="220px"  HorizontalAlign="Left"/>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemStyle CssClass="mp_incell" HorizontalAlign="Center" />
                        <ControlStyle cssclass="button button_review" />
                        <ItemTemplate>
                            <asp:Button runat="server" id="btnCreateReview"
                                CommandName="RequestNewReview" CommandArgument=<%# DataBinder.Eval(Container.DataItem,"InitiativeID")%> Text="Request New Review" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderStyle CssClass="mp_headcell" HorizontalAlign="Center"/>
                        <ItemStyle CssClass="mp_incell" HorizontalAlign="Center" />
                        <ControlStyle cssclass="button button_pir" />
                        <ItemTemplate>
                            <asp:Button runat="server" id="btnCreatePIR"
                                CommandName="RequestNewPIR" CommandArgument=<%# DataBinder.Eval(Container.DataItem,"InitiativeID")%> Text="Request New PIR" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
