...
public partial class Review_AllocateUBR : System.Web.UI.Page
{
    ...
    protected void LoadDataSets()
    {
        try
        {
            ...
            dsSponsorUBRAllocs = SectionB_SponsorAllocations_DB.GetInitiativeSponsorUBRAllocationForEdit(nInitiativeID, sponsorID, Session.SessionID, storeSponsorLevel, 1);
