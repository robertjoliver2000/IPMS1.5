<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectsImportUBR.aspx.cs" Inherits="ProjectsImportUBR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Quarterly UBR Update</title>
    <base target="_self">
...
<body>
    ...
    <div>
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Height="41px"
            Text="Import UBR" Width="505px"></asp:Label><br />
        <br />
    <table width="100%">
    <tr>
    ...
    <tr>
        <td align="left" colspan="5">
            3. Save Upload.
            <asp:Button ID="btnSaveProjects" CssClass="def" runat="server" OnClick="btnSaveProjects_Click" Text="Save UBR Upload" Enabled="False" EnableViewState="False" />
            &nbsp;</td>
    </tr>
        <tr>
            <td align="left" colspan="5">
                4. Process Upload &nbsp;<asp:Button ID="btnPart1" runat="server" Height="19px" OnClick="btnPart1_Click" Text="Process UBR Upload" CssClass="def" /></td>
        </tr>
        <tr>
            <td align="left" colspan="5" style="display: none">
                3 - ii Save Financial Data Part 2
                <asp:Button ID="btnPart2" runat="server" Height="19px" OnClick="btnPart2_Click" Text="Part 2"
                    Width="113px" /></td>
        </tr>
        <tr>
            <td align="left" colspan="5">
