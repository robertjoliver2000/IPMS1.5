<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Review_SectionB_ProgramDeliverables.ascx.cs" Inherits="ProjectPortfolio.Controls.Review_SectionB_ProgramDeliverables" %>
			...
			<asp:repeater id="rptProgramDeliverables" EnableViewState="False" runat="server" OnItemDataBound="rptProgramDeliverables_ItemDataBound" OnItemCommand="rptProgramDeliverables_ItemCommand">
				<HeaderTemplate>
					...
					<tr runat="Server" id="trHeader">
						<td class="emptynopadding" width="0px" style="background-color:#eaeaea; border: 0px;"></td>
						<td class="headcell" width="245px" align="left" style="border-left: 0px">Key Deliverables</td>
						<td class="headcell" width="80px" align="center">Due Date</td>
						<td class="headcell" width="80px" align="center">Cost (€M) </td>
						<td class="headcell" width="145px" align="left" style="border-right: 0px">Affected Applications</td>
						<td class="emptynopadding" width="0px" style="background-color:#eaeaea; border: 0px;"></td>
					</tr>
				</HeaderTemplate>
				<ItemTemplate>
					<tr runat="Server" id="trItem">
						...
						<td class="incell" width="245px" runat="Server" id="tdName">
						...
						<td class="incell" width="145px" align="left"><%# DataBinder.Eval(Container.DataItem,"AffectedApplications")%>&nbsp;</td>
						<td class="emptynopadding" width="0px"></td>
					</tr>
				</ItemTemplate>
				<AlternatingItemTemplate>
					<tr runat="Server" id="trItem">
						<td class="emptynopadding" width="0px"></td>
						<td class="alternateincell" width="245px" runat="Server" id="tdName">
						    <table cellpadding="0" cellspacing="0" border="0">
						        <tr>
						            <td width="20px"><asp:ImageButton runat="server" ID="imgDelete" CausesValidation="false" ImageUrl="~/Images/delete.gif" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"DeliverableID")%>' CommandName="Delete"></asp:ImageButton></td>
						            <td><a runat="server" id="lnkAddDeliverable" href="#" onclick='<%# "javascript:popupWindowAddDeliverable(" + DataBinder.Eval(Container.DataItem,"InitiativeID") + ", " + DataBinder.Eval(Container.DataItem,"DeliverableID") + "); return false; "%>'><%# DataBinder.Eval(Container.DataItem,"Name")%></a></td>
						...
						<td class="alternateincell" width="145px" align="left"><%# DataBinder.Eval(Container.DataItem,"AffectedApplications")%>&nbsp;</td>
						<td class="emptynopadding" width="0px"></td>
					</tr>
                </AlternatingItemTemplate>	
                <FooterTemplate>
					<tr runat="Server" id="trTotal">
						...
						<td class="totalcell" width="245px">Total Cost</td>
						<td class="totalcell" width="80px"></td>
						<td class="totalcell" width="80px" runat="server" id="tdTotalCost" align="right"></td>
						<td class="totalcell" width="145px" ></td>
						<td class="emptynopadding" width="0px"></td>
					</tr>
					<tr>
