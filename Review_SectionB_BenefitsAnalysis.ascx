<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Review_SectionB_BenefitsAnalysis.ascx.cs" Inherits="ProjectPortfolio.Controls.Review_SectionB_BenefitsAnalysis" %>
	    ...
	    <td>
            <table border="0" cellpadding="0" cellspacing="0" style="padding-right:4px;">
                <tr>
                    ...
                    <td>
                    <asp:TextBox Runat="server" readonly="true" ID="txtIGReviewDate" style="text-align: center;" CssClass="textinput" Width="100px"></asp:TextBox>
                    <asp:RangeValidator ID="RVsectionB_rvIGReviewDate" runat="server" ControlToValidate="txtIGReviewDate" Text="*" MaximumValue="1/1/2020" 
	                     ErrorMessage="Review Date incorrect date format" MinimumValue="1/1/1900" Type="Date" ValidationGroup="SubmitForReview"></asp:RangeValidator>
	                 <asp:RequiredFieldValidator ID="RVsectionB_rvIGReviewDate2" runat="server" ControlToValidate="txtIGReviewDate"
                        ErrorMessage="Review Date must not be blank" ValidationGroup="SubmitForReview" Width="1px">*</asp:RequiredFieldValidator>
	                </td>
                    <td width="20px" align="center"><a runat="server" id="lnkIGReviewDate"><img src="Images/calendar.jpg" border="0"></a></td>
                    <td width="20px" align="center"><asp:RangeValidator ID="rvIGReviewDate" runat="server" ControlToValidate="txtIGReviewDate" Text="*" MaximumValue="1/1/2020" MinimumValue="1/1/1900" Type="Date" ErrorMessage="Current Review Date is not a valid date." ValidationGroup="SubmitForReview" ></asp:RangeValidator></td>
                </tr>
            </table>
        </td>
	</tr>
        ...
        <td align="left">
	        <table border="0" cellpadding="0" cellspacing="0" style="padding-right:4px;">
	            <tr>
                	...
                	<td class="summarylabel">Date</td>
	                <td><asp:TextBox Runat="server" ID="txtIGLastReviewDate" style="text-align: center;" readonly="true" CssClass="textinput" Width="100px"></asp:TextBox>
                            </td>
	            </tr>
	        </table>
		</td>
